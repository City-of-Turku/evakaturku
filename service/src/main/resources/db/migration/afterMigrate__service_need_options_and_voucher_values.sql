...
VALUES
    ...
    ('503591ae-b961-11eb-b521-1fca99358eef', 'Varhaiskasvatus enintään 27h/vko (enintään 116h/kk)', 'Småbarnspedagogik högst 27,5h/vecka (högst 116h/mån)', 'Full-time, 15 day agreement', 'DAYCARE', FALSE, 0.65, 1.0, 27.5, FALSE, FALSE, 'Varhaiskasvatus enintään 27h/vko (enintään 116h/kk)', 'Småbarnspedagogik högst 27,5h/vecka (högst 116h/mån)', 'Varhaiskasvatus enintään 27h/vko (enintään 116h/kk)', 'Småbarnspedagogik högst 27,5h/vecka (högst 116h/mån)', 2, 1.75, true),
    ...
    ('50359212-b961-11eb-b522-074fb05f7086', 'Osapäiväinen, max 5h päivässä', 'Osapäiväinen, max 5h päivässä', 'Part-time, max 5h per day', 'DAYCARE', TRUE, 0.6, 0.6, 25, TRUE, FALSE, 'Osapäiväinen, max 5h päivässä', 'Osapäiväinen, max 5h päivässä', 'Osapäiväinen, max 5h päivässä', 'Osapäiväinen, max 5h päivässä', null, 1.75, false),
    ('86ef7370-bf85-11eb-91e7-6fcd728c518d', 'Osapäiväinen, max 5h päivässä', 'Osapäiväinen, max 5h päivässä', 'Part-time, max 5h per day', 'DAYCARE', FALSE, 0.6, 0.6, 25, TRUE, FALSE, 'Osapäiväinen, max 5h päivässä', 'Osapäiväinen, max 5h päivässä', 'Osapäiväinen, max 5h päivässä', 'Osapäiväinen, max 5h päivässä', 1001, 1.75, false),
    ...
    --PRESCHOOL
    ('bc6a4550-fa74-11eb-9a2d-035acd5db9aa', 'Esiopetus 4h/pv', 'Förskole undervisning 4h/dag', 'Preschool 4h/day', 'PRESCHOOL', TRUE, 0, 0.5, 20, TRUE, FALSE, 'Esiopetus 4h/pv', 'Förskole undervisning 4h/dag', 'Esiopetus 4h/pv', 'Förskole undervisning 4h/dag', null, 1.75, true),

    --PRESCHOOL_DAYCARE
    ('0bfc6c92-ff2a-11eb-a785-2724e8e5e7ee', 'Esiopetus 4h/pv + varhaiskasvatus yli 147h/kk (100%)', 'Förskole undervisning 4h/dag + småbarnspedagogik över 147t/mån (100%)', 'Preschool 4h/day + early childhood education over 147h/month (100%)', 'PRESCHOOL_DAYCARE', TRUE, 1.0, 1.0, 40, FALSE, FALSE, 'Esiopetus 4h/pv + varhaiskasvatus yli 147h/kk (100%)', 'Förskole undervisning 4h/dag + småbarnspedagogik över 147t/mån (100%)', 'Esiopetus 4h/pv + varhaiskasvatus yli 147h/kk (100%)', 'Förskole undervisning 4h/dag + småbarnspedagogik över 147t/mån (100%)', null, 1.75, true),
    ('503593e8-b961-11eb-b527-a3dcdfb628ec', 'Esiopetus 4h/pv + varhaiskasvatus yli 147h/kk (100%)', 'Förskole undervisning 4h/dag + småbarnspedagogik över 147t/mån (100%)', 'Preschool 4h/day + early childhood education over 147h/month (100%)', 'PRESCHOOL_DAYCARE', FALSE, 1.0, 1.0, 40, FALSE, FALSE, 'Esiopetus 4h/pv + varhaiskasvatus yli 147h/kk (100%)', 'Förskole undervisning 4h/dag + småbarnspedagogik över 147t/mån (100%)', 'Esiopetus 4h/pv + varhaiskasvatus yli 147h/kk (100%)', 'Förskole undervisning 4h/dag + småbarnspedagogik över 147t/mån (100%)', 2000, 1.75, true),
    ('50359442-b961-11eb-b528-df3290c0d63e', 'Esiopetus 4h/pv + varhaiskasvatus enintään 147h/kk (85%)', 'Förskole undervisning 4h/dag + småbarnspedagogik högst 147t/mån (85%)', 'Preschool 4h/day + early childhood education at most 147h/month (85%)', 'PRESCHOOL_DAYCARE', FALSE, 0.85, 1.0, 35, FALSE, FALSE, 'Esiopetus 4h/pv + varhaiskasvatus enintään 147h/kk (85%)', 'Förskole undervisning 4h/dag + småbarnspedagogik högst 147t/mån (85%)', 'Esiopetus 4h/pv + varhaiskasvatus enintään 147h/kk (85%)', 'Förskole undervisning 4h/dag + småbarnspedagogik högst 147t/mån (85%)', 2100, 1.75, true),
    ('bc6a42d0-fa74-11eb-9a2b-d315a7916074', 'Esiopetus 4h/pv + varhaiskasvatus enintään 116h/kk (65%)', 'Förskole undervisning 4h/dag + småbarnspedagogik högst 116t/mån (65%)', 'Preschool 4h/day + early childhood education at most 116h/month (65%)', 'PRESCHOOL_DAYCARE', FALSE, 0.65, 1.0, 27.5, TRUE, TRUE, 'Esiopetus 4h/pv + varhaiskasvatus enintään 116h/kk (65%)', 'Förskole undervisning 4h/dag + småbarnspedagogik högst 116t/mån (65%)', 'Esiopetus 4h/pv + varhaiskasvatus enintään 116h/kk (65%)', 'Förskole undervisning 4h/dag + småbarnspedagogik högst 116t/mån (65%)', 2200, 1.75, true),

    --PREPARATORY
    ('1b4413f6-d99d-11eb-89ac-a3a978104bce', 'Valmistava opetus', 'Förbererande utbilndning', 'Preparatory education', 'PREPARATORY', TRUE, 0, 0.54, 25, TRUE, FALSE, 'Valmistava opetus', 'Förbererande utbilndning', 'Valmistava opetus', 'Förbererande utbilndning', null, 1.75, true),

    --PREPARATORY_DAYCARE
    ('bc6a44ec-fa74-11eb-9a2c-73b53c2af869', 'Valmistava opetus + varhaiskasvatus yli 147h/kk (100%)', 'Förbererande utbilndning + småbarnspedagogik över 147h/mån  (100%)', 'Preschool daycare – max 5 h per day; 15 day agreement', 'PRESCHOOL_DAYCARE', FALSE, 1.0, 1.0, 40, TRUE, TRUE, 'Valmistava opetus + varhaiskasvatus yli 147h/kk (100%)', 'Förbererande utbilndning + småbarnspedagogik över 147h/mån  (100%)', 'Valmistava opetus + varhaiskasvatus yli 147h/kk (100%)', 'Förbererande utbilndning + småbarnspedagogik över 147h/mån  (100%)', 2300, 1.75, true),
    ('bc6a45a0-fa74-11eb-9a2e-fb411a8588da', 'Valmistava opetus + varhaiskasvatus yli 147h/kk (100%)', 'Förbererande utbilndning + småbarnspedagogik över 147h/mån  (100%)', 'Preschool daycare – max 5 h per day; 15 day agreement', 'PRESCHOOL_DAYCARE', FALSE, 1.0, 1.0, 40, TRUE, TRUE, 'Valmistava opetus + varhaiskasvatus yli 147h/kk (100%)', 'Förbererande utbilndning + småbarnspedagogik över 147h/mån  (100%)', 'Valmistava opetus + varhaiskasvatus yli 147h/kk (100%)', 'Förbererande utbilndning + småbarnspedagogik över 147h/mån  (100%)', 2301, 1.75, true),

    --TEMPORARY_DAYCARE
    ('5035938e-b961-11eb-b526-6b30323c87a8', 'Tilapäinen varhaiskasvatus', 'Tillfällig småbarnspedagogik', 'Temporary early childhood education', 'TEMPORARY_DAYCARE', TRUE, 1.0, 0.54, 40, FALSE, FALSE, 'Tilapäinen varhaiskasvatus', 'Tillfällig småbarnspedagogik', 'Tilapäinen varhaiskasvatus', 'Tillfällig småbarnspedagogik', null, 1.75, true),
