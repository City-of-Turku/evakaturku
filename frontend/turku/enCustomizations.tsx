...
const en: DeepPartial<Translations> = {
  applications: {
    creation: {
      ...
      transferApplicationInfo: {
        DAYCARE:
          'The child already has a place in early childhood education in Turku. With this application you can apply for a transfer to another unit offering early childhood education in Turku.'
      }
    },
    editor: {
      heading: {
      ...
      serviceNeed: {
        ...
        assistanceNeedInstructions: {
          DAYCARE:
            'Intensified or special care is given to a child as soon as the need arises. If a child has received an expert opinion backing the need for support, this must be notified in the early childhood education application. The support measures are carried out in the child’s daily life as part of the early childhood educational activities. Turku’s early childhood education will separately be in contact after the application has been submitted, if the child has a need for support.',
          CLUB: 'If the child has a need for support, the staff of Turku’s early childhood education will get in contact the application has been submitted.'
        },
        partTime: {
          true: 'Part-time'
        },
      ...
      contactInfo: {
        ...
        futureAddressInfo:
          'In Turku’s early childhood education, the official address is considered the one obtainable from the population data register. The address in the population data register changes when an applicant gives notice of a move to the post office or to the registry office.'
      },
      fee: {
        info: {
          DAYCARE: (
        ...
        links: (
          <P>
            ...
            <ExternalLink
              ...
              text="the website of the City of Turku"
              newTab
            />
          </P>
        )
  ...
  vasu: {
    givePermissionToShareInfoVasu:
      "If you want to change the recipients mentioned in the plan, contact the staff of your child's early childhood education unit. When a child changes to another early childhood education unit in the City of Turku, the early childhood education plan and other early childhood education documents are transferred to the new unit (also applies to early childhood education organized by Turku as a purchasing service). The guardian will be informed about the transfer in advance. We ask the guardian for permission to hand over the early childhood education plan to an outsider. However, if a child enters private or other municipality's early childhood education, the early childhood education plan must be submitted to the new early childhood education provider even without permission, if the information is necessary for arranging the child's early childhood education (section 41 (3) of the Early Childhood Education Act). In addition, the early childhood education plan must be submitted to the organizer of pre-primary or primary education if it is necessary for the organization of the child's education (section 41 (4) of the Basic Education Act). The guardian will be informed of the transfer in advance."
  }
}
